...
public class TrackerActivityPRCP extends FragmentActivity implements OnMapReadyCallback, LocationConsumer {
    ...
    private CronometroAUX cronometroAUX;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cronometroAUX = new CronometroAUX(mTimerText, 0);
        ...
        trackDB = new TrackDB(TrackerActivityPRCP.this);
    }
